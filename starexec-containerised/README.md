...
- For remote server access, use:
  `ssh -f -N -L 8080:*starexec_server.your_domain*:80 *your_account@starexec_server.your_domain*
  - If necessary, add jump host options, ala `-J *your_account@jumphost.jumphost_domain*`
