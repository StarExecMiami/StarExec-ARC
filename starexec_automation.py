...
class StarExecAutomator:
    ...
    def wait_for_element(self, by: By, selector: str, timeout: int = WAIT_TIMEOUT, 
                         condition: callable = EC.element_to_be_clickable) -> WebDriver:
        """
    ...
    def login(self) -> None:
        ...
        try:
            ...
            logger.info(f"Logged in successfully, current URL: {self.driver.current_url}")
        except Exception as e:
    ...
    def upload_solver(self, solver_path: str) -> None:
        ...
        try:
            ...
            upload_solver_element = self.driver.find_element(By.CSS_SELECTOR, "#uploadSolver")
            upload_solver_element.click()
            
            self.wait_for_element(By.CSS_SELECTOR, "#fileLoc", 
    ...
    def upload_benchmark(self, benchmark_path: str) -> None:
        ...
        try:
            ...
            upload_bench_element = self.driver.find_element(By.CSS_SELECTOR, "#uploadBench")
            ...
            bench_upload_button = self.driver.find_element(By.CSS_SELECTOR, "#btnUpload")
    ...
    def create_job(self) -> None:
        ...
        try:
            ...
            keep_hierarchy_element = self.driver.find_element(By.CSS_SELECTOR, "#keepHierarchy")
            keep_hierarchy_element.click()

            done_button = self.driver.find_element(By.CSS_SELECTOR, "#btnDone > span.ui-button-text")
            done_button.click()
    ...
    def _configure_job_parameters(self) -> None:
        ...
        wallclock_timeout_element = self.driver.find_element(By.CSS_SELECTOR, "#wallclockTimeout")
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--solver-path',
                        required=True,
                        help='Path to the solver zip file')
    parser.add_argument('--benchmark-path',
                        required=True,
                        help='Path to the benchmark tgz file')
    ...
    if (args.password is None or args.password == '') and 'STAREXEC_PASSWORD' in os.environ:
